        ...
        <div class="space-y-5">
          ...
          <section class="mh-card p-5">
            ...
            <dl class="space-y-3 text-xs">
              ...
              <div class="flex justify-between gap-3">
                <dt class="text-soft">图库原图</dt>
                <dd>{{ formatBytes(workspace.overview?.bytes) }}</dd>
              </div>
              <div class="flex justify-between gap-3">
                <dt class="text-soft">回收站原图</dt>
                <dd>{{ formatBytes(workspace.overview?.trashBytes) }}</dd>
              </div>
              <div class="flex justify-between gap-3">
                <dt class="text-soft">单文件上传上限</dt>
                <dd>{{ formatBytes(capabilities?.upload.maxBytes) }}</dd>
              </div>
              <div class="flex justify-between gap-3">
                <dt class="text-soft">图像像素上限</dt>
                <dd>
                  {{
                    capabilities
            ...
            <p class="mt-4 text-[11px] leading-6 text-faint">
              不包含缩略图、预览图及其他用户数据。存储路径与服务器容量需由部署环境管理。
            </p>
          </section>
        </div>
      </div>
